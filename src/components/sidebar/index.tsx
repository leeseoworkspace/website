...
export default function Sidebar() {
	...
	const waveUrl =
		theme === "dark" ? "url('/wave-dark.svg')" : "url('/wave.svg')";
			...
			<section className="bg-secondary bg-[url('/noise.webp')] h-20 md:h-[98vh] w-full md:w-52 flex flex-row md:flex-col items-center md:items-stretch md:pt-6 px-4 md:px-4 z-50 overflow-hidden relative rounded-3xl rounded-b-none md:rounded-none md:rounded-r-none">
				...
				<div className="hidden md:block z-50 pointer-events-none">
					<div
						...
						className="absolute -bottom-12 -left-19 w-full h-15 bg-repeat-x bg-size-[100%_60px] scale-y-[-1]"
					/>
					<div
						style={{ backgroundImage: waveUrl }}
						className="absolute -bottom-12 left-0 w-full h-15 bg-repeat-x bg-size-[100%_60px] scale-y-[-1]"
					/>
					<div
						style={{ backgroundImage: waveUrl }}
						className="absolute -bottom-12 left-19 w-full h-15 bg-repeat-x bg-size-[100%_60px] scale-y-[-1]"
				...
				<div className="md:hidden z-50 pointer-events-none">
					<div
						style={{ backgroundImage: waveUrl }}
						className="absolute -bottom-13 -left-57 w-full h-15 bg-repeat-x bg-size-[100%_60px] scale-y-[-1]"
					/>
					<div
						style={{ backgroundImage: waveUrl }}
					...
					<div
						style={{ backgroundImage: waveUrl }}
						className="absolute -bottom-13 -left-38 w-full h-15 bg-[url('/wave.svg')] bg-repeat-x bg-size-[100%_60px] scale-y-[-1]"
					/>
					<div
						style={{ backgroundImage: waveUrl }}
						className="absolute -bottom-13 -left-19 w-full h-15 bg-[url('/wave.svg')] bg-repeat-x bg-size-[100%_60px] scale-y-[-1]"
					/>
					<div
						style={{ backgroundImage: waveUrl }}
						className="absolute -bottom-13 left-0 w-full h-15 bg-[url('/wave.svg')] bg-repeat-x bg-size-[100%_60px] scale-y-[-1]"
					/>
					<div
						style={{ backgroundImage: waveUrl }}
						className="absolute -bottom-13 left-19 w-full h-15 bg-[url('/wave.svg')] bg-repeat-x bg-size-[100%_60px] scale-y-[-1]"
